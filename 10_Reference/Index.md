...
- [[10_Reference/tools/julia-1|Julia 1]] — local decision model; Apache-2.0; reference only, not installed
- [[wiki/sources/julia-1|Julia 1 (source)]] — lab page + model card + `julia/model.py` + accuracy JSON
- [[wiki/entities/supersonic-labs|Supersonic Labs]] / [[wiki/concepts/supplied-option-ranker|Supplied-option ranker]]
