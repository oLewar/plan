---
title: "HKUDS/OpenSpace: \"OpenSpace: Make Your Agents: Smarter, Low-Cost, Self-Evolving\" -- Community: https://open-space.cloud/"
source: "https://github.com/HKUDS/OpenSpace"
author:
published:
created: 2026-04-14
description: "\"OpenSpace: Make Your Agents: Smarter, Low-Cost, Self-Evolving\" -- Community: https://open-space.cloud/ - HKUDS/OpenSpace"
tags:
  - "clippings"
---
...
cloud\_community.mp4<video src="https://private-user-images.githubusercontent.com/151314054/568361909-c50f70ab-f6db-47bf-9498-3210c0f0abae.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NzYxNjk1NjIsIm5iZiI6MTc3NjE2OTI2MiwicGF0aCI6Ii8xNTEzMTQwNTQvNTY4MzYxOTA5LWM1MGY3MGFiLWY2ZGItNDdiZi05NDk4LTMyMTBjMGYwYWJhZS5tcDQ_.X5TZoZLZAa7KcO3QDASIPC6nAfEqDoE-Yi5iqtpolTE" controls="controls"></video>
...
- [🏗️ Framework](#%EF%B8%8F-framework)
...
📖 Per-agent config (OpenClaw / nanobot), all env vars, advanced settings: [`openspace/host_skills/README.md`](https://github.com/HKUDS/OpenSpace/blob/main/openspace/host_skills/README.md)
...
> [!note] Note
> Create a `.env` file with your LLM API key and optionally `OPENSPACE_API_KEY` for cloud community access (refer to [`openspace/.env.example`](https://github.com/HKUDS/OpenSpace/blob/main/openspace/.env.example)).
...
Add your own custom skills: [`openspace/skills/README.md`](https://github.com/HKUDS/OpenSpace/blob/main/openspace/skills/README.md).
...
**Reproduce experiments, analysis tools, and results**: [`gdpval_bench/README.md`](https://github.com/HKUDS/OpenSpace/blob/main/gdpval_bench/README.md)
...
**Full details**: [`showcase/README.md`](https://github.com/HKUDS/OpenSpace/blob/main/showcase/README.md)
...
For most users, [Quick Start](#-quick-start) is all you need. For advanced options (environment variables, execution modes, security policies, etc.), see [`openspace/config/README.md`](https://github.com/HKUDS/OpenSpace/blob/main/openspace/config/README.md).
