...
See the [environments example](https://github.com/vercel-labs/agent-browser/blob/main/examples/environments) for a working demo with a UI and deploy-to-Vercel button.
