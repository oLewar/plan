...
published:
created: 2026-04-13
description: "Autoresearch for subjective domains. Contribute to NousResearch/autoreason development by creating an account on GitHub."
tags:
  - "clippings"
---
...
[Paper (PDF)](https://github.com/NousResearch/autoreason/blob/main/paper/autoreason.pdf) · [Human Eval Materials](https://github.com/NousResearch/autoreason/blob/main/human_eval)
...
Blinded materials for human raters are in [`human_eval/`](https://github.com/NousResearch/autoreason/blob/main/human_eval). 5 tasks × 3 methods (autoreason, critique-and-revise, single-pass), randomized 4-character codes. See [`human_eval/README.md`](https://github.com/NousResearch/autoreason/blob/main/human_eval/README.md) for the rubric and instructions.
