...
published:
created: 2026-04-14
description: "Ask the oracle when you're stuck. Invoke GPT-5 Pro with a custom context and files. - steipete/oracle"
tags:
  - "clippings"
---
...
- Configure clients via [steipete/mcporter](https://github.com/steipete/mcporter) or `.mcp.json`; see [docs/mcp.md](https://github.com/steipete/oracle/blob/main/docs/mcp.md) for connection examples.
```
npx -y @steipete/oracle oracle-mcp
```
- Cursor setup (MCP): drop a `.cursor/mcp.json` like below, then pick “oracle” in Cursor’s MCP sources. See [https://cursor.com/docs/context/mcp](https://cursor.com/docs/context/mcp) for UI steps.
```
{
  "oracle": {
    "command": "oracle-mcp",
...
Use `browser.chatgptUrl` (or the legacy alias `browser.url`) to target a specific ChatGPT workspace/folder for browser automation. See [docs/configuration.md](https://github.com/steipete/oracle/blob/main/docs/configuration.md) for precedence and full schema.
...
- Bridge (Windows host → Linux client): [docs/bridge.md](https://github.com/steipete/oracle/blob/main/docs/bridge.md)
- Browser mode & forks: [docs/browser-mode.md](https://github.com/steipete/oracle/blob/main/docs/browser-mode.md) (includes `oracle serve` remote service), [docs/chromium-forks.md](https://github.com/steipete/oracle/blob/main/docs/chromium-forks.md), [docs/linux.md](https://github.com/steipete/oracle/blob/main/docs/linux.md)
- MCP: [docs/mcp.md](https://github.com/steipete/oracle/blob/main/docs/mcp.md)
- OpenAI/Azure/OpenRouter endpoints: [docs/openai-endpoints.md](https://github.com/steipete/oracle/blob/main/docs/openai-endpoints.md), [docs/openrouter.md](https://github.com/steipete/oracle/blob/main/docs/openrouter.md)
- Manual smokes: [docs/manual-tests.md](https://github.com/steipete/oracle/blob/main/docs/manual-tests.md)
- Testing: [docs/testing.md](https://github.com/steipete/oracle/blob/main/docs/testing.md)

If you’re looking for an even more powerful context-management tool, check out [https://repoprompt.com](https://repoprompt.com/)  
Name inspired by: [https://ampcode.com/news/oracle](https://ampcode.com/news/oracle)
