---
title: "AlexMoreo/pydci: A Python implementation of the Distributional Correspondence Indexing algorithm"
source: "https://github.com/AlexMoreo/pydci"
author:
published:
created: 2026-04-20
description: "A Python implementation of the Distributional Correspondence Indexing algorithm - AlexMoreo/pydci"
tags:
  - "clippings"
---
...
A bunch of scripts have been added to replicate experiments using TDCI (the transductive variant of DCI for cross-lingual and cross-domain adaptation). Those scripts are marked with a "\_transductive" postfix. SVMlight is required in order to make them work. The paper discussing this variant and the results is currently under review.