---
title: "openai/privacy-filter: OpenAI Privacy Filter"
source: "https://github.com/openai/privacy-filter"
author:
published:
created: 2026-05-19
description: "OpenAI Privacy Filter. Contribute to openai/privacy-filter development by creating an account on GitHub."
tags:
  - "clippings"
---
...
Repository resources: [License](https://github.com/openai/privacy-filter/blob/main/LICENSE) and [Security Policy](https://github.com/openai/privacy-filter/blob/main/SECURITY.md).
...
- License: [Apache 2.0](https://github.com/openai/privacy-filter/blob/main/LICENSE)
- Model weights: [https://huggingface.co/openai/privacy-filter](https://huggingface.co/openai/privacy-filter)
- Demo: [https://huggingface.co/spaces/openai/privacy-filter](https://huggingface.co/spaces/openai/privacy-filter)
