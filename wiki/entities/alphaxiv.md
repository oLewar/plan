...
| Field | Value |
|---|---|
| Type | Company / GitHub org (paper tooling + research workspace) |
| GitHub org | [alphaXiv](https://github.com/alphaXiv) — created 2023-12-14; **119** public repos (org API 2026-09-16) |
| Site | https://www.alphaxiv.org |
| Product site | https://openresearch.sh/ |
| X | [@askalphaxiv](https://x.com/askalphaxiv) (already in [[40_Research/ai-signal-monitor/x-ai-accounts]]) |
| First wiki source | [[wiki/sources/openresearch]] |
| License (OpenResearch) | MIT, «Copyright (c) 2026 alphaXiv» |
...
- OpenResearch **v0.2.3** (2026-09-16). HEAD `325eb509dc8e` (2026-09-16). Stars **3858** (GitHub API 2026-09-16). Repo created 2026-06-07.
- Companion split: `orx` is local; `openresearch.sh` owns accounts/orgs/managed compute.
- This Hermes host: `orx` **not installed**. Registry has no Hermes adapter.
